...
function Navigation() {
  ...
  return (
    ...
    <div className="nav-logo">
      <img src="https://images.pexels.com/photos/16666915/pexels-photo-16666915.jpeg?auto=compress&cs=tinysrgb&w=1600&lazy=load" alt="Portfolio Logo" />
    </div>
        ...
        <li>
          ...
          <div className="submenu">
            <ul className="dropdown">                                        
              ...
              <li><a href="/it/networking">Networking</a></li>
              <li><a href="/it/cloud">Cloud</a></li>
              <li><a href="/it/experience">My Experience</a></li>              
            </ul>
          </div>
        </li>                
        <Search />
        <li><a href="#" data-side onClick={openSide}>Accessibillity</a></li>
      </ul>
